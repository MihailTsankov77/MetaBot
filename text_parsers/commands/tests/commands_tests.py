...
class CommandsTests(unittest.TestCase):
    ...
    def test_build_commands_string_1(self):
        self.assertEqual(build_commands_string([('mat2', 'x', 'y'), ('mat3', 'z')], 'player', -1), 'player.mat2(x, y)\nplayer.mat3(z)')

    def test_build_commands_string_2(self):
        self.assertEqual(build_commands_string([('mat2', 'x', 'y'), ('mat3', 'z')], 'player', 0), '<font color=#00FF00>player.mat2(x, y)</font>\nplayer.mat3(z)')
    
    def test_build_commands_string_3(self):
        self.assertEqual(build_commands_string([('mat2', 'x', 'y'), ('mat3', 'z')], 'player', 1), '<font color=#FF0000>player.mat2(x, y)</font>\n<font color=#00FF00>player.mat3(z)</font>')
